...
class DetailActivity : AppCompatActivity() {
    private lateinit var binding1: ActivityDetailBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding1 = ActivityDetailBinding.inflate(layoutInflater)
        ...
        binding1.recyclerView2.adapter = DetailAdapter(dataList)

        val adapter = DetailAdapter(dataList)
        binding1.recyclerView2.adapter = adapter
